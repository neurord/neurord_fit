...
params = aju.optimize.ParamSet(P('pNMDARPP1_fwd_rate',
                                 4e-9, min=0, max=1e-3,
                                 xpath='//Reaction[@id="pNMDARPP1_bind"]/forwardRate'),
                               P('pNMDARPP1_bak_rate',
                                 0.34e-3, min=0, max=1e-3,
                                 xpath='//Reaction[@id="pNMDARPP1_bind"]/reverseRate'),
                               P('pNMDARPP1_kcat_rate',
                                 0.086e-3, min=0, max=1e-3,
                                 xpath='//Reaction[@id="pNMDARPP1_reac"]/forwardRate'))
